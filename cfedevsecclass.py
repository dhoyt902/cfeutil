...
command1 = 'scp fwappsadmin@138.208.253.26:/var/lib/cfengine3/masterfiles/secclasses.cf /tmp/secclasses.cf'
command2 = 'scp /tmp/secclasses.cf fwappsadmin@138.208.253.26:/var/lib/cfengine3/masterfiles/secclasses.cf'
command3 = "ssh fwappsadmin@138.208.253.26 'sudo chown root:cfebootstrap /var/lib/cfengine3/masterfiles/secclasses.cf;sudo rm -rf /var/lib/cfengine3/inputs/*;sudo cp -rf /var/lib/cfengine3/masterfiles/* /var/lib/cfengine3/inputs/;cf-promises -v'"
badlist = []
TEMPLATE = """
<html>
<head>
...
<form method="post" action="cfedevsecclass.py" name="secclasses">
...
<form method="post" action="cfedevsecclass.py" name="Server Query">Query
...
<form method="post" action="cfedevsecclass.py" name="Class Query">Query
