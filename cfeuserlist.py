...
command1 = 'scp fwappsadmin@138.208.1.90:/var/lib/cfengine3/masterfiles/userlist.cf /tmp/userlist.cf'
command2 = 'scp /tmp/userlist.cf fwappsadmin@138.208.1.90:/var/lib/cfengine3/masterfiles/userlist.cf'
command3 = "ssh fwappsadmin@138.208.1.90 'sudo chown root:cfebootstrap /var/lib/cfengine3/masterfiles/userlist.cf;sudo \
...
<form method="post" action="cfeuserlist.py" name="userlist">
...
<form method="post" action="cfeuserlist.py" name="Server Query">Query
...
<form method="post" action="cfeuserlist.py" name="Class Query">Query
