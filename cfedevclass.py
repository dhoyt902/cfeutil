...
command1 = 'scp fwappsadmin@138.208.253.26:/var/lib/cfengine3/masterfiles/classes.cf /tmp/classes.cf'
command2 = 'scp /tmp/classes.cf fwappsadmin@138.208.253.26:/var/lib/cfengine3/masterfiles/classes.cf'
command3 = "ssh fwappsadmin@138.208.253.26 'sudo chown root:cfebootstrap /var/lib/cfengine3/masterfiles/classes.cf;sudo rm -rf /var/lib/cfengine3/inputs/*;sudo cp -rf /var/lib/cfengine3/masterfiles/* /var/lib/cfengine3/inputs/;cf-promises -v'"
...
<form method="post" action="cfedevclass.py" name="classes">
...
<form method="post" action="cfedevclass.py" name="Server Query">Query
...
<form method="post" action="cfedevclass.py" name="Class Query">Query
